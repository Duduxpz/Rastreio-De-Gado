...
export function Button({
  ...
  const variants = {
    primary: 'bg-accent-500 text-white hover:bg-accent-600 active:bg-accent-700 font-semibold',
    secondary:
      'bg-primary-700 text-white hover:bg-primary-600 active:bg-primary-500',
    danger: 'bg-red-500 text-white hover:bg-red-600 active:bg-red-700',
    ghost: 'text-white hover:bg-primary-700 active:bg-primary-600',
  };
